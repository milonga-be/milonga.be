<?php
	...
	$cformsSettings['form'.$no]['mp']['cforms'.$no.'_mp_form'] = $_REQUEST['cforms_mp_form']?true:false;
	...
	if ( $_REQUEST['cforms_mp_form']==true && $_REQUEST['cforms_mp_next']=='' )
		...
		$cformsSettings['form'.$no]['mp']['cforms'.$no.'_mp_next'] = $_REQUEST['cforms_mp_next'];



	$cformsSettings['form'.$no]['mp']['cforms'.$no.'_mp_first'] = 	$_REQUEST['cforms_mp_first']?true:false;

	$cformsSettings['form'.$no]['mp']['cforms'.$no.'_mp_email'] = 	$_REQUEST['cforms_mp_email']?true:false;

	$cformsSettings['form'.$no]['mp']['cforms'.$no.'_mp_reset'] = 	$_REQUEST['cforms_mp_reset']?true:false;

	$cformsSettings['form'.$no]['mp']['cforms'.$no.'_mp_resettext']=$_REQUEST['cforms_mp_resettext'];

	$cformsSettings['form'.$no]['mp']['cforms'.$no.'_mp_back'] = 	$_REQUEST['cforms_mp_back']?true:false;

	$cformsSettings['form'.$no]['mp']['cforms'.$no.'_mp_backtext'] =$_REQUEST['cforms_mp_backtext'];
