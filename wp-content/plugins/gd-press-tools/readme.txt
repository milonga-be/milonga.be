...
Tags: admin, dev4press, database backup, auto tagger, tag, seo, url scan, tools, press, revisions, gdragon, post, page, security, tracking, administration, php, update, mysql, database, integration, cron
...
You only need POEdit program that works on Windows, Linux and MacOS. Instructions on how to make or update translations are here: http://d4p.me/wa.
...
Admin side loading optimization. Proper use of enqueue files functions. Using new context help added in WordPress 3.3. Improvements and changes for WordPress 3.6. Removed many obsolete code and files. Removed settings that are no longer in use. Replaced found deprecated functions. Dropped support for WordPress 2.8 and 2.9. Fully updated POT translation file. Fixed several path and URL issues. Fixed few minor reported problems.
...
* Using new context help added in WordPress 3.3

* Improvements and changes for WordPress 3.6

* Removed many obsolete code and files

* Removed settings that are no longer in use

* Replaced found deprecated functions

* Dropped support for WordPress 2.8 and 2.9

* Fully updated POT translation file

* Fixed several path and URL issues

* Fixed few minor reported problems
