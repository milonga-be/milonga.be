    ...
    <td>
        ...
        <table cellpadding="0" cellspacing="0" class="previewtable">
            ...
            <tr>
                ...
                <td height="25"><input type="text" id="gdpt_cmm_date" name="gdpt_cmm_date" value="" /> (yyyy-mm-dd)</td>
    ...
    <td>
        ...
        <table cellpadding="0" cellspacing="0" class="previewtable">
            ...
            <tr>
                ...
                <td height="25"><input type="text" id="gdpt_delposts_date" name="gdpt_delposts_date" value="" /> (yyyy-mm-dd)</td>
